...
def load_and_filter_gdf(col, str_code):
    ...
    gdf = gpd.read_file("../riverline/W05-06_38_GML/W05-06_38-g_Stream.shp")
    return gdf[gdf[col] == str_code]


def create_map(filtered_gdf, r_name, str_code, resolution):
    river_bounds = filtered_gdf.total_bounds
    ...
    #fig.savefig(f"../map/{r_name}_{str_code}.png")
    fig.savefig(f"../fig/{r_name}_{str_code}.png")
